...
| --- | --- | --- | --- |
| `company` | string | Yes | Company name, company slug, or valid company URL for which news articles should be fetched. Example: `tesla`. |
...
<Info>
  Supported categories are available in the Akta Playground category selector.
</Info>
